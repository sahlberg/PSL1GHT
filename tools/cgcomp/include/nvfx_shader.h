...
static INLINE struct nvfx_insn nvfx_insn_ctor(struct nvfx_insn *insn,struct nvfx_reg dst,struct nvfx_src s0,struct nvfx_src s1,struct nvfx_src s2)
{
	struct nvfx_insn dest_insn;
	...
	dest_insn.sat = insn->sat;
	dest_insn.cc_update = insn->cc_update;
	dest_insn.cc_update_reg = insn->cc_update_reg;
...
static INLINE struct nvfx_reg nvfx_reg(s32 type,s32 index)
{
...
static INLINE struct nvfx_src nvfx_src(struct nvfx_reg reg)
{
...
static INLINE struct nvfx_src nvfx_src_swz(struct nvfx_src src,s32 x,s32 y,s32 z,s32 w)
{
...
static INLINE struct nvfx_src nvfx_src_neg(struct nvfx_src src)
{
	src.negate = !src.negate;
	return src;
}

static INLINE struct nvfx_src nvfx_src_abs(struct nvfx_src src)
{
	src.abs = 1;
	return src;
}
